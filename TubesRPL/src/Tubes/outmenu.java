 ...
 * @author User
 */
public class outmenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(scroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 130));
        ...
        jPanel1.add(txtTambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 180, 100, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(outmenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void tabelData() {
        String[] judul = {"ID","Nama Makanan Minuman","Harga"};
